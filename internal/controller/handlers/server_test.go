...
import (
	...
	storageMocks "github.com/bbt-t/lets-go-keep/internal/storage/mocks"
...
func TestNewServerHandlers(t *testing.T) {
	store, auth := storageMocks.NewStorager(t), mocks.NewAuthenticator(t)
